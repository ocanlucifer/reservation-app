...
@section('content')
    <div class="d-flex justify-content-between align-items-center mb-3">
        <h1 class="mb-0">Reservasi Kujungan</h1>
    </div>
    ...
    <form id="filter-form" class="mb-4">
        ...
        <div class="col-md-12 mt-3 text-justify">
            <div class="row align-items-center g-2">
                <!-- Status Filter -->
                <div class="col-auto ms-auto">
                    <label for="t_g_req" class="form-label mb-0" title="Request">
                        {{-- <i class="fas fa-toggle-on"></i> --}}
                        Request
                    </label>
                </div>
                <div class="col-auto">
                    <select name="t_g_req" id="t_g_req" class="form-select form-select-sm">
    ...
    <div id="table-container">
        @include('visit_reservation.table')
    </div>
...
<script>
    $(document).ready(function() {
        ...
        function fetchvisitSchedules() {
            ...
            $.ajax({
                url: "{{ route('visitReservations.index') }}",
                method: "GET",
                data: formData,
