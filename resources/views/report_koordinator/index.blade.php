...
@section('content')
    <div class="d-flex justify-content-between align-items-center mb-3">
        <h1 class="mb-0">Laporan Koordinator</h1>
        <div>
    ...
    <div id="table-container">
        @include('report_koordinator.table')
    </div>
...
<script>
    $(document).ready(function() {
        ...
        function fetchvisitSchedules() {
            ...
            $.ajax({
                url: "{{ route('reportkoordinator.index') }}",
                method: "GET",
                data: formData,
        ...
        $('#exportExcel').on('click', function () {
            ...
            const url = "{{ route('reportkoordinator.export.excel') }}?" + formData; // Tambahkan filter ke URL
        ...
        $('#exportPDF').on('click', function () {
            const formData = $('#filter-form').serialize(); // Ambil filter
            const url = "{{ route('reportkoordinator.export.pdf') }}?" + formData; // Tambahkan filter ke URL
