...
class ReportKoordinatorController extends Controller
{
    public function index(Request $request)
    {
        ...
        if ($request->ajax()) {
            return view('report_koordinator.table', compact('visitSchedules', 'search', 'sortBy', 'order', 'perPage', 'fromDate', 'toDate'));
        }

        return view('report_koordinator.index', compact('visitSchedules', 'search', 'sortBy', 'order', 'perPage', 'fromDate', 'toDate'));
    }
    ...
    public function exportExcel(Request $request)
    {
        ...
        return Excel::download(new KoordinatorExport($visitSchedules), 'report_koordinator.xlsx');
    }
    ...
    public function exportPDF(Request $request)
    {
        ...
        // Render PDF
        $pdf = Pdf::loadView('report_koordinator.pdf', compact('visitSchedules', 'imageSrc'))
        ...
        return $pdf->stream('Laporan koordinator.pdf');
    }
}
