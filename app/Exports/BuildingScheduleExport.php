    ...
    public function collection()
    {
        ...
        foreach ($this->buildingSchedules as $buildingSchedule) {
            $data[] = [
                ...
                'Pengunjung / Pengguna' => $buildingSchedule->visitReservation->visitor_name.' ('.$buildingSchedule->visitReservation->visitor_company.')',
                'Tujuan Kunjungan' => $buildingSchedule->visitReservation->visitor_purphose,
